...
try
    ...
    master.set_timeout(mbTimeout1000.0)
except
...
while True
    ...
    def is_network_alive()
        ...
        try
            ...
            match = re.search(rrtt minavgmaxmdev = (d+.d+)(d+.d+)(d+.d+)(d+.d+) ms, output.decode(utf-8))
            if match
    ...
    def Publish_MQTT()
        time.sleep(1)
        client.publish(2706PM3133RelayValueData, RelayValuePayload)
        client.publish(2706PM3133SystemParameterSettingData, SystemParameterSettingPayload)
        client.publish(2706PM3133SystemInformationData, SystemInformationPayload)
        client.publish(2706PM3133PowerAData, PowerAPayload)
        client.publish(2706PM3133PowerBData, PowerBPayload)
        client.publish(2706PM3133PowerCData, PowerCPayload)
        client.publish(2706PM3133PowerTotalData, PowerTotalPayload)
        client.publish(2706PowerBox, PowerBoxGetPayload)
